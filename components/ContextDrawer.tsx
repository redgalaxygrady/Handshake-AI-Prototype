...
const ContextDrawer: React.FC<ContextDrawerProps> = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      <div 
        className={`fixed top-0 right-0 h-full bg-white border-l border-slate-200 transition-transform duration-300 ease-in-out z-50 overflow-y-auto shadow-2xl ${isOpen ? 'translate-x-0' : 'translate-x-full'} w-[85vw] sm:w-80 md:w-[400px] flex flex-col`}
      >
